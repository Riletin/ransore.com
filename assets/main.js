...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('#image01', { style: 'zoom-out-image', speed: 1000, intensity: 6, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#text01', { style: 'zoom-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#text02', { style: 'zoom-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('.icons.style1', { style: 'zoom-in', speed: 1000, intensity: 5, threshold: 5, delay: 0, stagger: 125, staggerOrder: 'random', staggerSelector: ':scope > li', state: true, replay: true });
		onvisible.add('#container01 > .wrapper > .inner', { style: 'zoom-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#divider03', { style: 'zoom-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#text03', { style: 'zoom-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#text04', { style: 'zoom-in', speed: 1000, intensity: 10, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#divider04', { style: 'zoom-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('.icons.style2', { style: 'zoom-in', speed: 1000, intensity: 5, threshold: 5, delay: 0, stagger: 125, staggerOrder: 'random', staggerSelector: ':scope > li', state: true, replay: true });
		onvisible.add('#divider02', { style: 'zoom-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#divider05', { style: 'zoom-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#text05', { style: 'zoom-in', speed: 1000, intensity: 10, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#divider08', { style: 'zoom-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('.icons.style3', { style: 'zoom-in', speed: 1000, intensity: 5, threshold: 5, delay: 0, stagger: 125, staggerOrder: 'random', staggerSelector: ':scope > li', state: true, replay: true });
		onvisible.add('#divider09', { style: 'zoom-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#divider10', { style: 'zoom-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#text07', { style: 'zoom-in', speed: 1000, intensity: 10, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#divider06', { style: 'zoom-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('.icons.style4', { style: 'zoom-in', speed: 1000, intensity: 5, threshold: 5, delay: 0, stagger: 125, staggerOrder: 'random', staggerSelector: ':scope > li', state: true, replay: true });
		onvisible.add('#divider01', { style: 'zoom-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#divider07', { style: 'zoom-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
